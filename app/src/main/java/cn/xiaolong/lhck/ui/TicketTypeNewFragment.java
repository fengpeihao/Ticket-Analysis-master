 ...
 * @date 2016/8/9-14:10
 */
public class TicketTypeNewFragment extends BaseFuncFragment {
    ...
    public static TicketTypeNewFragment getNewInstance(TicketTypeEnum ticketTypeEnum) {
        TicketTypeNewFragment fragment = new TicketTypeNewFragment();
