...
public class ActivityFragment1 extends BaseTitleBarActivity {
    ...
    @Override
    protected void init() {
        TicketTypeNew2Fragment fragment1 = TicketTypeNew2Fragment.getNewInstance(TicketTypeEnum.values()[2]);
