...
class StatusBarCompatLollipop {
     ...
     */
    static void translucentStatusBarForImage(Activity activity, boolean hideStatusBarBackground) {
        Window window = activity.getWindow();
     ...
     */
    static void translucentStatusBar(Activity activity, boolean hideStatusBarBackground,View bgView) {
        Window window = activity.getWindow();
    ...
    static void translucentStatusBarForFragment(Fragment fragment, boolean hideStatusBarBackground) {
        ...
        ViewGroup contentView = (ViewGroup) fragment.getActivity().findViewById(android.R.id.content);
        if (contentView != null) {
            View rootView;
